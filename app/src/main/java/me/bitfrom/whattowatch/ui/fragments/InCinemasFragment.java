...
public class InCinemasFragment extends BaseFragment implements InCinemasMvpView,
    ...
    @Inject
    protected InCinemasPresenter mInCinemasPresenter;
    @Inject
    ...
    public void onStart() {
        ...
        mInCinemasPresenter.attachView(this);
        mInCinemasPresenter.getFilms();
    }
    ...
    public void loadNewFilms(boolean pullToRefresh) {
        mInCinemasPresenter.loadFilms(pullToRefresh);
    }
